...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { content: @phrase.content, hashid: @phrase.hashid } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { content: @phrase.content, hashid: @phrase.hashid } }
