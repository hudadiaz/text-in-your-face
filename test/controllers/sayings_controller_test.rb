...
class SayingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saying" do
    assert_difference('Saying.count') do
      post sayings_url, params: { saying: { style_id: @saying.style_id, thing_id: @saying.thing_id } }
    end
  ...
  test "should update saying" do
    patch saying_url(@saying), params: { saying: { style_id: @saying.style_id, thing_id: @saying.thing_id } }
